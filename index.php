...
<body class="min-h-screen font-sans antialiased">
  ...
  <script>
    ...
    function generateWhatsAppMessage(real) {
      ...
      if (real.prix_indicatif) message += `💰 Prix indicatif : $${parseFloat(real.prix_indicatif).toFixed(2)}\n`;
