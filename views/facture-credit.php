...
<head>
    ...
    <style>
        ...
        .ticket::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #8B5CF6 0%, #EC4899 100%); /* Violet-rose pour crédit */
        }
        ...
        .text-super-dark { color: #000000 !important; }
            ...
            <tbody>
                ...
                <tr class="<?= $index % 2 === 0 ? 'bg-gray-50' : '' ?>">
                    <td class="py-1.5 pr-2">
                        ...
                        <div class="text-[8px] opacity-90">Unité: <?= $uniteText ?></div>
                    </td>
                    <td class="text-center py-1.5">
                        <span class="font-bold"><?= number_format((float)$art['quantite'], 3) ?></span>
                    </td>
